<x-auth-layout title="Register">
    <div class="w-full p-6 bg-white border border-zinc-200 shadow-md rounded-lg">
        <h2 class="text-center text-2xl font-bold text-zinc-800 mb-2">Create Account</h2>
        ...
        <form action="{{ route('auth.store') }}" method="POST" class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                <label for="password_confirmation" class="font-semibold text-sm text-zinc-700">Confirm Password</label>
