<x-template_default title="Tambah Jenis" section-title="Tambah Jenis Komponen">
    <div class="flex justify-center">
        <div class="w-full max-w-lg p-6 bg-white border border-zinc-200 shadow-md rounded-lg">
            <form action="{{ route('admin.jenis_komponen.store') }}" method="POST">
                @csrf
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="submit" class="bg-blue-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-700">Simpan</button>
                </div>
            </form>
        </div>
    </div>
